...
const Footer = () => {
  return (
    <footer className="text-gray-600 mt-12 fixed bottom-0 left-0 right-0 w-full bg-white">
      <div className="flex items-center flex-col sm:flex-row py-8 container mx-auto">
        <Link href="/">
